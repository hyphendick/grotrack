	...
	<body>
		...
		<div id="show-team" class="content scaffold-show" role="main">
			...
			<ol class="property-list team">
				...
				<g:if test="${teamInstance?.athletes}">
				<li class="fieldcontain">
					<span id="athletes-label" class="property-label"><g:message code="team.athletes.label" default="Athletes" /></span>
					
						<g:each in="${teamInstance.athletes}" var="a">
